...
export const toMm = (value: number, unit: PlannerUnit | string): number => {
...
export const fromMm = (mm: number, unit: PlannerUnit | string): number => {
...
export const formatDim = (mm: number, unit: PlannerUnit | string): string => {
