...
// Mild "slightly brighter" — not the previous strong push
...
fs.writeFileSync(
  "results/asset-cutover/hero-slides-slightly-brighter.json",
  JSON.stringify({ generatedAt: new Date().toISOString(), params: { BRIGHTNESS, SAT, LINEAR_A, LINEAR_B, SHARPEN }, report }, null, 2)
);
